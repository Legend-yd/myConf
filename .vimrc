...
set re=0 " 防止redrawtime exceeded syntax 错误
...
let g:ycm_max_num_candidates = 13  "最长候选集"
"}
...
"go中一些高量打开
  ...
  let g:go_gopls_gofumpt=1             "使用更严格的gofumpt来校验"
...
"rainbow_parentheses 彩色括号 Setting{
"let g:rbpt_colorpairs = [
    ...
    au Syntax * RainbowParenthesesLoadRound       "选项用于开启对 圆括号 () 的多彩色高亮匹配，该选项默认被开启；
    au Syntax * RainbowParenthesesLoadSquare      "选项用于开启对 方括号 [] 的多彩色高亮匹配；
    au Syntax * RainbowParenthesesLoadBraces      "选项用于开启对 大括号 {} 的多彩色高亮匹配；
    au Syntax * RainbowParenthesesLoadChevrons    "选项用于开启对 尖括号 <> 的多彩色高亮匹配
"}
